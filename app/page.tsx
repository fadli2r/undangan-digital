...
const categories: Category[] = [
  { name: "Minimalis", emoji: "✨", count: 25, description: "Desain simpel dan elegan", color: "#6366f1" },
  { name: "Floral", emoji: "🌸", count: 30, description: "Tema bunga dan alam", color: "#10b981" },
  { name: "Modern", emoji: "🎯", count: 28, description: "Desain kontemporer", color: "#3b82f6" },
  { name: "Vintage", emoji: "🏛️", count: 15, description: "Gaya klasik & retro", color: "#f59e0b" },
];

const features: Feature[] = [
  { emoji: "🎨", title: "Desain Premium yang Mudah Disesuaikan", description: "Ratusan layout unik, edit teks & warna secara instan.", color: "#4361ee" },
  { emoji: "👁️", title: "Preview Real-Time", description: "Lihat hasil akhir undangan sebelum diunduh.", color: "#3a0ca3" },
  { emoji: "🤝", title: "Dukungan Pelanggan 24/7", description: "Tim kami siap membantu hingga undangan sampai di tangan Anda.", color: "#7209b7" },
  { emoji: "📱", title: "Digital & Mobile-Friendly", description: "Undangan responsif dan mudah dibagikan.", color: "#560bad" },
];
        ...
        <section className="relative pt-32 pb-20 bg-gradient-to-br from-red-600 via-pink-600 to-blue-800 text-white min-h-screen flex items-center">
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10" style={{ maxWidth: "1200px" }}>
            <div className="text-center">
              ...
              <p
                className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto mb-12 animate__animated animate__fadeInUp"
              ...
              {/* CTA Buttons */}
              <div
                className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate__animated animate__fadeInUp"
              ...
              {/* Stats */}
              <div
                className="grid grid-cols-3 gap-8 max-w-2xl mx-auto animate__animated animate__fadeInUp"
          ...
          <div className="max-w-7xl mx-auto px-4" style={{ maxWidth: "1200px" }}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, idx) => (
                <div
                  key={idx}
                  className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center"
                >
                  <div className="mb-4">
                    <div
          ...
          <div className="max-w-7xl mx-auto px-4" style={{ maxWidth: "1200px" }}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {Array.isArray(templateList) && templateList.length > 0 ? (
                templateList.slice(0, 6).map((template: any, idx: number) => (
                  <div
                    key={idx}
                    className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
                  >
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h5 className="text-xl font-bold text-gray-900 mb-2">
                        Template Premium {idx + 1}
                      </h5>
                      <p className="text-gray-600 text-sm mb-4">
                        Desain elegan untuk undangan pernikahan Anda
                      </p>
                      <div className="flex justify-between items-center">
                        <span className="text-lg font-bold text-blue-600">Mulai Rp 50.000</span>
                        <Link
            ...
            <div className="text-center mt-12">
              <Link
                href="/katalog"
                className="bg-gray-900 text-white hover:bg-gray-800 px-8 py-4 rounded-full font-semibold text-lg transition duration-300"
              >
          ...
          <div className="max-w-7xl mx-auto px-4" style={{ maxWidth: "1200px" }}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {categories.map((category, idx) => (
                <Link
                  key={idx}
                  href={`/katalog?category=${category.name.toLowerCase()}`}
                  className="block"
                >
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="max-w-7xl mx-auto px-4" style={{ maxWidth: "1200px" }}>
            ...
            <div className="text-center mt-12">
              ...
              <Link
                href="/paket"
                className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-3 rounded-full font-semibold transition duration-300"
              >
                Lihat Semua Paket
              </Link>
            </div>
