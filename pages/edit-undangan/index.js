...
export default function EditUndangan() {
  ...
  // Since we're filtering on API level, we don't need client-side filtering
  const filteredUndangan = undanganList;
      ...
      async (result) => {
        if (result.isConfirmed) {
          ...
          try {
            ...
            showAlert.error(
              'Gagal!',
              'Gagal menduplikasi undangan. Silakan coba lagi.'
            );
          }
        }
      }
      ...
      async (result) => {
        if (result.isConfirmed) {
          ...
          try {
            ...
            showAlert.error(
              'Gagal!',
              'Gagal menghapus undangan. Silakan coba lagi.'
            );
          }
        }
      }
