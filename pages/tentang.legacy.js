...
const teamMembers = [
  {
    ...
    description: "Berpengalaman 10 tahun di industri desain digital dan pernikahan."
  },
  {
    name: "Sarah Amalia",
    role: "Creative Director",
    image: "/images/team/creative-director.jpg",
    description: "Background desain grafis dengan spesialisasi di typography dan layout."
  },
  {
    name: "Budi Santoso",
    role: "Tech Lead",
    image: "/images/team/tech-lead.jpg",
    description: "Ahli pengembangan web dengan fokus pada user experience."
  }
];
...
const values = [
  {
    title: "Kreativitas",
    description: "Selalu berinovasi dalam setiap desain untuk memberikan yang terbaik.",
    icon: (
  ...
  {
    title: "Kualitas",
    description: "Mengutamakan kualitas dalam setiap aspek layanan kami.",
    icon: (
      <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Memberikan pengalaman terbaik untuk setiap pelanggan.",
    icon: (
      <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function About() {
  return (
    <>
      <Head>
        <title>Tentang Kami - Undangan Digital</title>
        <meta name="description" content="Penyedia layanan undangan digital premium dengan pengalaman lebih dari 5 tahun." />
      </Head>
