                ...
                <div className="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
                  <div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div className="menu-item">
                      <Link href="/admin" className={`menu-link ${router.pathname === '/admin' ? 'active' : ''}`}>
                    ...
                    <div className="menu-item">
                      <Link href="/admin/users" className={`menu-link ${router.pathname.startsWith('/admin/users') ? 'active' : ''}`}>
                        <span className="menu-icon">
                    ...
                    <div className="menu-item">
                      <Link href="/admin/invitations" className={`menu-link ${router.pathname.startsWith('/admin/invitations') ? 'active' : ''}`}>
                        <span className="menu-icon">
                    ...
                    <div className="menu-item">
                      <Link href="/admin/packages" className={`menu-link ${router.pathname.startsWith('/admin/packages') ? 'active' : ''}`}>
                        <span className="menu-icon">
                    ...
                    <div className="menu-item">
                      <Link href="/admin/orders" className={`menu-link ${router.pathname.startsWith('/admin/orders') ? 'active' : ''}`}>
                        <span className="menu-icon">
                    ...
                    <div className="menu-item">
                      <Link href="/admin/coupons" className={`menu-link ${router.pathname.startsWith('/admin/coupons') ? 'active' : ''}`}>
                        <span className="menu-icon">
                    ...
                    <div className="menu-item">
                      <Link href="/admin/settings" className={`menu-link ${router.pathname.startsWith('/admin/settings') ? 'active' : ''}`}>
                        <span className="menu-icon">
              ...
              <div className="aside-footer flex-column-auto px-9" id="kt_aside_footer">
                ...
                <div className="d-flex flex-stack">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      {/* Begin::Name */}
                      <Link href="/admin/settings" className="text-gray-800 text-hover-primary fs-6 fw-bold lh-1">
                  ...
                  <div className="ms-1">
                    ...
                    <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                      ...
                      <div className="menu-item px-5">
                        <Link href="/admin/settings" className="menu-link px-5">My Profile</Link>
                      </div>
                      {/* End::Menu item */}
                      
                      {/* Begin::Menu item */}
                      <div className="menu-item px-5 my-1">
                        <Link href="/admin/settings" className="menu-link px-5">Account Settings</Link>
                      </div>
                      {/* End::Menu item */}
              ...
              <div className="footer py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div className="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                  ...
                  <div className="text-gray-900 order-2 order-md-1">
                    ...
                    <Link href="/" target="_blank" className="text-gray-800 text-hover-primary">Digital Invitation</Link>
                  </div>
                  {/* End::Copyright */}
                  {/* Begin::Menu */}
                  <ul className="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                    <li className="menu-item">
                      <Link href="/" target="_blank" className="menu-link px-2">About</Link>
                    </li>
                    <li className="menu-item">
                      <Link href="/kontak" target="_blank" className="menu-link px-2">Support</Link>
                    </li>
                  </ul>
                  {/* End::Menu */}
                </div>
