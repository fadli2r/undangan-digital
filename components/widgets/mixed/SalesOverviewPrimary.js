export default function SalesOverviewPrimary() {
  return (
    <div className="card card-xl-stretch mb-xl-8">
      <div className="card-header border-0 py-5">
        ...
        <div className="card-toolbar">
          ...
          <div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_sales_overview_primary">
            ...
            <div className="px-7 py-5">
              <div className="mb-10">
                ...
                <div>
                  <select className="form-select form-select-solid" multiple data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_sales_overview_primary" data-allow-clear="true">
      ...
      <div className="card-body p-0 d-flex flex-column">
        ...
        <div className="mixed-widget-3-chart card-rounded-bottom" data-kt-chart-color="primary" style={{ height: 150 }} />
      </div>
    </div>
  );
}
