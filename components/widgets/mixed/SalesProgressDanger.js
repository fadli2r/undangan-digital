export default function SalesProgressDanger() {
  return (
    <div className="card card-xl-stretch mb-xl-8">
      ...
      <div className="card-body p-0">
        <div className="mixed-widget-12-chart card-rounded-bottom bg-danger" data-kt-color="danger" style={{ height: 250 }} />
