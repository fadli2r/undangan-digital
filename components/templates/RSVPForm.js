// components/templates/RSVPForm.js
'use client';

import { useEffect, useState } from 'react';

/**
 * @param {{ slug: string; namaTamu?: string }} props
 */
export default function RSVPForm({ slug, namaTamu }) {
  ...
  // Prefill/keep in sync kalau namaTamu berubah
  useEffect(() => {
    if (namaTamu) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            readOnly={!!namaTamu} // kalau datang dari link personal, kunci input
          />
          {namaTamu && (
        ...
        {form.kehadiran === 'hadir' && (
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, jumlah_tamu: Math.max(1, Math.min(5, parseInt(e.target.value) || 1)) })
              }
            />
