...
// Jangan throw error saat build time, hanya warning
if (!MONGODB_URI) {
  console.warn(
...
async function dbConnect() {
  // Jika tidak ada MONGODB_URI, return null (untuk build time)
  if (!MONGODB_URI) {
    console.warn('Skipping database connection: MONGODB_URI not defined');
    return null;
  }
